#!/bin/bash
#(Optionl) define relevent seqOutBias tables. Path to directory and specific file.
sob=/media/ninadmw/sgate4/06052017-T1DGC_ATACSeq-40229196
sob_tbl=hg38_38.4.2.2.tbl    
sob_txt=hg38.tal_38.gtTxt.gz  
#Reference for FRiP calculations. Path to directory and specific file.
ref=/media/ninadmw/sgate4/ATAC_automation2
ref_file=CD19_hotSpot_liftedhg19tohg38.bed 
...
mkdir -p LibraryStats/Insertsize
